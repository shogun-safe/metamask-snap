/**
 * @file Unit tests for {@link rlpHexToKeccak256Hash}.
 */
...
describe('rlpHexToKeccak256Hash', () => {
  it('returns 64-character hex string (no 0x prefix)', () => {
    ...
    expect(hash).not.toMatch(/^0x/u);
  });

  it('same input produces same hash', () => {
    const rlpHex =
      '0x02f86c808504a817c80082520894adf3b878ebb0b31a64c279d50c4f0c0e3c69e7e0880de0b6b3a764000080c0';
  ...
  it('accepts hex without 0x prefix', () => {
    ...
    expect(rlpHexToKeccak256Hash(withPrefix)).toBe(
      rlpHexToKeccak256Hash(withoutPrefix),
    );
  });
